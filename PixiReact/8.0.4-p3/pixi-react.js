(function (global, factory) {
    ...
    function isEqual(inputA, inputB, options = {
      ...
      if (isFunction(inputA) && isFunction(inputB)) {
    ...
    const reconcilerConfig = {
      // PATCH исправление React Dev Tools
      ...
      // PATCH Поддержка асинхронных тасков, должно помочь
      // батчить апдейты dom и pixi-react.
