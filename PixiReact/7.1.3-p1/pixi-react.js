(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, global.requirejs('pixi8'), global.requirejs('react')) :
  typeof define === 'function' && define.amd ? define('pixi-react7', ['exports', 'pixi8', 'react'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["pixi-react7"] = {}, global.pixi8, global.React));
})(typeof globalThis !== 'undefined' ? globalThis : global || this,(function (exports, pixi8, React) { 'use strict';
  ...
  function isPointType(value) {
    return value instanceof pixi8.Point || value instanceof pixi8.ObservablePoint;
  }
   ...
   * @type {Object}
   */
  var PROPS_RESERVED = (_PROPS_RESERVED = {}, _defineProperty(_PROPS_RESERVED, CHILDREN, true), _defineProperty(_PROPS_RESERVED, "parent", true), _defineProperty(_PROPS_RESERVED, "localColor", true), _defineProperty(_PROPS_RESERVED, "localAlpha", true), _defineProperty(_PROPS_RESERVED, "groupAlpha", true), _defineProperty(_PROPS_RESERVED, "groupColor", true), _defineProperty(_PROPS_RESERVED, "groupColorAlpha", true), _defineProperty(_PROPS_RESERVED, "localBlendMode", true), _defineProperty(_PROPS_RESERVED, "groupBlendMode", true), _defineProperty(_PROPS_RESERVED, "localVisibleRenderable", true), _defineProperty(_PROPS_RESERVED, "groupVisibleRenderable", true), _defineProperty(_PROPS_RESERVED, "renderPipeId", true), _defineProperty(_PROPS_RESERVED, "includeInBuild", true), _defineProperty(_PROPS_RESERVED, "measurable", true), _defineProperty(_PROPS_RESERVED, "isSimple", true), _defineProperty(_PROPS_RESERVED, "updateTick", true), _defineProperty(_PROPS_RESERVED, "localTransform", true), _defineProperty(_PROPS_RESERVED, "relativeGroupTransform", true), _defineProperty(_PROPS_RESERVED, "groupTransform", true), _defineProperty(_PROPS_RESERVED, "worldTransform", true), _defineProperty(_PROPS_RESERVED, "worldVisible", true), _PROPS_RESERVED);
  ...
  var getTextureFromProps = function getTextureFromProps(elementType, root) {
    ...
    if (props.texture) {
      invariant(props.texture instanceof pixi8.Texture, "".concat(elementType, " texture needs to be typeof `Texture`"));
    ...
    var result = check('image', {
      ...
      instanceofs: [HTMLImageElement, HTMLVideoElement, HTMLCanvasElement, pixi8.Texture]
    });
    ...
    var texture = pixi8.Texture.from(result);
    texture.__reactpixi = {
      root: root
    };
  ...
  function applyDefaultProps(instance, oldProps, newProps) {
    var changed = false;
    invariant(pixi8.Container.prototype.isPrototypeOf(instance), 'instance needs to be typeof `Container`, got `%s`', _typeof(instance));
  ...
  var Graphics$1 = function Graphics(root, _ref) {
    ...
    invariant(!geometry || geometry instanceof pixi8.Graphics, "Graphics geometry needs to be a `Graphics`");
    var g = geometry ? new pixi8.Graphics(geometry.clone(true)) : new pixi8.Graphics();
  ...
  var NineSliceSprite$1 = function NineSliceSprite(root, props) {
    ...
    var texture = getTextureFromProps('NineSliceSprite', root, props);
    var nineSliceSprite = new pixi8.NineSliceSprite({
      texture: texture,
      leftWidth: leftWidth,
      topHeight: topHeight,
    ...
    nineSliceSprite.applyProps = function (instance, oldProps, newProps) {
  ...
  var NineSliceSprite$2 = NineSliceSprite$1;

  var _excluded$5 = ["image", "texture"];
  var Sprite$1 = function Sprite(root, props) {
    var sprite = new pixi8.Sprite(getTextureFromProps('Sprite', root, props));
  ...
  var AnimatedSprite$1 = function AnimatedSprite(root, props) {
    ...
    var makeTexture = function makeTexture(textures) {
      return textures.map(function (texture) {
        invariant(texture instanceof pixi8.Texture || (texture === null || texture === void 0 ? void 0 : texture.texture), "AnimationSprite texture needs to be an array of `Texture` or `{ texture: Texture, time:\n                number }`");
        return texture;
      });
    };
    var animatedSprite = images ? pixi8.AnimatedSprite.fromImages(images) : new pixi8.AnimatedSprite(makeTexture(textures));
    ...
    animatedSprite.applyProps = function (instance, oldProps, newProps) {
      ...
      if (images && oldProps.images !== images) {
        ...
        for (var i = 0; i < images.length; ++i) {
          newTextures.push(pixi8.Texture.from(images[i]));
        }
  ...
  var Text$1 = function Text(root, props) {
    ...
    var pixiText = new pixi8.Text({
      text: text,
      style: style
    });
    if (isSprite) {
      var app = root.__reactpixi.app;
      var texture = app.renderer.canvasText.getTexture(text, app.renderer.resolution, pixiText.style, pixiText._getKey());
      return new pixi8.Sprite(texture);
    }
    return pixiText;
  };
  var Text$2 = Text$1;
  ...
  var MeshSimple$1 = function MeshSimple(root, props) {
    var texture = getTextureFromProps('Mesh', root, props);
    var vertices = props.vertices,
      uvs = props.uvs,
      indices = props.indices,
      _props$topology = props.topology,
      topology = _props$topology === void 0 ? 'triangle-list' : _props$topology;
    var simpleMesh = new pixi8.MeshSimple({
      texture: texture,
      vertices: vertices,
      uvs: uvs,
      indices: indices,
  ...
  var MeshSimple$2 = MeshSimple$1;

  var _excluded$1 = ["image", "texture"];
  var MeshRope$1 = function MeshRope(root, props) {
    var texture = getTextureFromProps('MeshRope', root, props);
    var points = props.points;
    var rope = new pixi8.MeshRope({
      texture: texture,
      points: points
    });
  ...
  var components = /*#__PURE__*/Object.freeze({
    ...
    Graphics: Graphics$2,
    NineSliceSprite: NineSliceSprite$2,
    Sprite: Sprite$2,
    Text: Text$2,
    TilingSprite: TilingSprite$2,
    MeshSimple: MeshSimple$2,
    MeshRope: MeshRope$2,
  ...
  // хак для поддержки работы pixi-react7 в режиме совместимости с React 17.0.1
  // Внимание, хак не переносить, после бандлоизации через rollup нужно чтобы данный код применился
  // первым в callback'е, подходит только это место, при размещении в других местах присвоение по итогу
  // происходит слишком поздно.
  // TODO удалить после перехода на React 18+
  React.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentActQueue = {
    current: null
  };
  ...
  var scripts = {
  	build: "nx run-many --target=build --all --parallel --skip-nx-cache && node scripts/patch-pixi-react.js",
  	test123: "node patch-pixi-react.js",
  ...
  function _removeChild(parent, child) {
    ...
    var _ref = (_child$config2 = child.config) !== null && _child$config2 !== void 0 ? _child$config2 : {},
      ...
      _ref$destroyTextureSo = _ref.destroyTextureSource,
      destroyTextureSource = _ref$destroyTextureSo === void 0 ? false : _ref$destroyTextureSo;
    if (destroy) {
  ...
  function unmountComponent(container) {
    invariant(pixi8.Container.prototype.isPrototypeOf(container), 'Invalid argument `container`, expected instance of `Container`.');
  ...
  */
  ...
  var TrackablePromise = /*#__PURE__*/function () {
    function TrackablePromise(promise) {
      var _this = this;
      _classCallCheck(this, TrackablePromise);
      _defineProperty(this, "isPending", void 0);
      _defineProperty(this, "isRejected", void 0);
      _defineProperty(this, "isFulfilled", void 0);
      _defineProperty(this, "promise", null);
      _defineProperty(this, "promiseCallback", null);
      this.isPending = true;
      this.isRejected = false;
      this.isFulfilled = false;
      this.promise = CancelablePromise.cancelable(promise);
      this.promise.then(function (value) {
        var _this$promiseCallback;
        (_this$promiseCallback = _this.promiseCallback) === null || _this$promiseCallback === void 0 ? void 0 : _this$promiseCallback.call(_this, value);
  ...
  var propTypes = {
    ...
    onUnmount: propTypesExports.func,
    // run ticker at start?
    raf: propTypesExports.bool,
    // render component on component lifecycle changes?
    renderOnComponentChange: propTypesExports.bool,
    children: propTypesExports.node,
    // PIXI options, see https://pixijs.download/dev/docs/app.Application.html
    options: propTypesExports.shape({
      antialias: propTypesExports.bool,
      autoDensity: propTypesExports.bool,
      autoStart: propTypesExports.bool,
      background: propTypesExports.number,
      backgroundAlpha: propTypesExports.number,
      backgroundColor: propTypesExports.number,
      bezierSmoothness: propTypesExports.number,
      clearBeforeRender: propTypesExports.bool,
      context: propTypesExports.any,
      eventFeatures: propTypesExports.object,
      eventMode: propTypesExports.string,
      failIfMajorPerformanceCaveat: propTypesExports.bool,
      forceFallbackAlpha: propTypesExports.bool,
      width: propTypesExports.number,
      height: propTypesExports.number,
      hello: propTypesExports.bool,
      manageImports: propTypesExports.bool,
      multiView: propTypesExports.bool,
      powerPreference: propTypesExports.string,
      preferences: propTypesExports.object,
      preferWebGLVersion: propTypesExports.number,
      premultipliedAlpha: propTypesExports.bool,
      preserveDrawingBuffer: propTypesExports.bool,
      resolution: propTypesExports.number,
      roundPixels: propTypesExports.bool,
      sharedTicker: propTypesExports.bool,
      sharedLoader: propTypesExports.bool,
      textureGCActive: propTypesExports.bool,
      textureGCMaxIdle: propTypesExports.number,
      textureGCCheckCountMax: propTypesExports.number,
      useBackBuffer: propTypesExports.bool,
      webgl: propTypesExports.object,
      webgpu: propTypesExports.object,
      ...
      canvas: function canvas(props, propName, componentName) {
        var el = props[propName];
        el && invariant(el instanceof HTMLCanvasElement, // eslint-disable-next-line max-len
        "Invalid prop `canvas` of type ".concat(_typeof(el), ", supplied to ").concat(componentName, ", expected `<canvas> Element`"));
      }
    })
  };
  var defaultProps = {
  ...
  function getCanvasProps(props) {
    var reserved = [].concat(_toConsumableArray(Object.keys(propTypes)), _toConsumableArray(Object.keys(PROPS_CONTAINER)));
  ...
  var Stage = /*#__PURE__*/function (_React$Component) {
    ...
    function Stage() {
      ...
      _defineProperty(_assertThisInitialized(_this), "appReady", null);
    ...
    _createClass(Stage, [{
      ...
      value: function componentDidMount() {
        ...
        this.app = new pixi8.Application();
        // eslint-disable-next-line no-void
        this.appReady = new TrackablePromise(this.app.init(_objectSpread$1(_objectSpread$1({
          width: width,
          height: height,
          canvas: this._canvas
        }, options), {}, {
        ...
        this.appReady.promiseCallback = function () {
          return _this2._initStage();
        };
      }
    }, {
      key: "componentDidUpdate",
      value: function componentDidUpdate(prevProps, prevState, prevContext) {
        var _this$appReady, _prevProps$options;
        if ((_this$appReady = this.appReady) !== null && _this$appReady !== void 0 && _this$appReady.isPending) return;
      ...
      value: function componentWillUnmount() {
        ...
        if ((_this$appReady2 = this.appReady) !== null && _this$appReady2 !== void 0 && _this$appReady2.isPending) {
          this.appReady.destroy();
          this.appReady = null;
          this.app = null;
          return;
      ...
      value: function render() {
        ...
        if (options && options.canvas) {
          invariant(options.canvas instanceof HTMLCanvasElement, 'options.canvas needs to be a `HTMLCanvasElement`');
          return null;
        }
        return /*#__PURE__*/React.createElement("canvas", _extends({}, getCanvasProps(this.props), {
          ref: function ref(c) {
            return _this3._canvas = c;
          }
        }));
      }
    }, {
      ...
      value: function _initStage() {
        var _this$props5 = this.props,
          onMount = _this$props5.onMount,
          options = _this$props5.options,
          raf = _this$props5.raf,
          renderOnComponentChange = _this$props5.renderOnComponentChange;
        if (this.app.renderer.type === pixi8.RendererType.WEBGL) {
  ...
  function useApp() {
    ...
    invariant(app instanceof pixi8.Application, 'No Context found with `%s`. Make sure to wrap component with `%s`', 'Application', 'AppProvider');
    return app;
  }

  var ticker = new pixi8.Ticker();
    ...
    React.useEffect(function () {
      if (enabled) {
        var tick = function tick(delta) {
          return savedRef.current.apply(ticker, [delta, ticker]);
        };
        ticker.add(tick);
        return function () {
          if (ticker) {
  ...
  var NineSliceSprite = TYPES.NineSliceSprite;
  var Sprite = TYPES.Sprite;
  var AnimatedSprite = TYPES.AnimatedSprite;
  var Text = TYPES.Text;
  var TilingSprite = TYPES.TilingSprite;
  var MeshSimple = TYPES.MeshSimple;
  var MeshRope = TYPES.MeshRope;
