(function (global, factory) {
   ...
   (factory((global = typeof globalThis !== 'undefined' ? globalThis : global || self).Slate = {}));
      ...
      function _regeneratorRuntime() {
         ...
         return (
            ...
            (e.isGeneratorFunction = function (t) {
               ...
               return (
                  !!e &&
                  (e === GeneratorFunction || 'GeneratorFunction' === (e.displayName || e.name))
               );
            }),
            (e.mark = function (t) {
               return (
   ...
   function _objectSpread$g(e) {
      for (var r = 1; r < arguments.length; r++) {
         ...
         r % 2
            ? ownKeys$g(Object(t), !0).forEach(function (r) {
   ...
   function _objectSpread$f(e) {
      for (var r = 1; r < arguments.length; r++) {
         var t = null != arguments[r] ? arguments[r] : {};
         r % 2
            ? ownKeys$f(Object(t), !0).forEach(function (r) {
                 _defineProperty(e, r, t[r]);
              })
            : Object.getOwnPropertyDescriptors
            ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
   ...
   function _createForOfIteratorHelper$l(o, allowArrayLike) {
      var it = (typeof Symbol !== 'undefined' && o[Symbol.iterator]) || o['@@iterator'];
      if (!it) {
         if (
            Array.isArray(o) ||
            (it = _unsupportedIterableToArray$l(o)) ||
   ...
   var Node = {
      ...
      /**
       * Пропатчено
       * Проверка на текст с которого была убрана ссылка
       * https://online.saby.ru/opendoc.html?guid=230cdb08-b334-43f0-b1fd-22fcbf6635ef&client=3
       */
      isNoLinkAutoWrapText: function isNoLinkAutoWrapText(node) {
         return Node.isText(node) && node.noAutoLinkWrap;
      },
      ...
      levels: function levels(root, path) {
         ...
         return /*#__PURE__*/ regenerator.mark(function _callee5() {
            var _iterator5, _step5, p, n;
            return regenerator.wrap(
               function _callee5$(_context5) {
                  while (1)
                     switch ((_context5.prev = _context5.next)) {
                        case 0:
                           _iterator5 = _createForOfIteratorHelper$l(Path.levels(path, options));
                           _context5.prev = 1;
                           _iterator5.s();
                        case 3:
      ...
      matches: function matches(node, props) {
         return (
            ...
            (Node.isText(node) && Text.isTextProps(props) && Text.matches(node, props))
         );
      },
      ...
      texts: function texts(root) {
         var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
         return /*#__PURE__*/ regenerator.mark(function _callee7() {
            var _iterator6, _step6, _step6$value, node, path;
            return regenerator.wrap(
               function _callee7$(_context7) {
                  while (1)
                     switch ((_context7.prev = _context7.next)) {
                        case 0:
                           _iterator6 = _createForOfIteratorHelper$l(Node.nodes(root, options));
                           _context7.prev = 1;
                           _iterator6.s();
                        case 3:
   ...
   */
   ...
   function _createForOfIteratorHelper$k(o, allowArrayLike) {
      var it = (typeof Symbol !== 'undefined' && o[Symbol.iterator]) || o['@@iterator'];
      if (!it) {
         if (
            Array.isArray(o) ||
            (it = _unsupportedIterableToArray$k(o)) ||
            (allowArrayLike && o && typeof o.length === 'number')
         ) {
            if (it) o = it;
            var i = 0;
   ...
   var getCharacterDistance = function getCharacterDistance(str) {
      ...
      var _iterator = _createForOfIteratorHelper$k(codepoints),
         _step;
      try {
   ...
   function isBoundaryPair(left, right) {
      return (
         NonBoundaryPairs.findIndex(function (r) {
   ...
   var Location = {
      ...
      isPath: function isPath(at) {
         return Array.isArray(at);
      },
      isPoint: function isPoint(at) {
         return 'offset' in at;
      },
      isRange: function isRange(at) {
         return 'anchor' in at;
      },
      isSpan: function isSpan(at) {
   ...
   function _createForOfIteratorHelper$j(o, allowArrayLike) {
      var it = (typeof Symbol !== 'undefined' && o[Symbol.iterator]) || o['@@iterator'];
      if (!it) {
         if (
            Array.isArray(o) ||
            (it = _unsupportedIterableToArray$j(o)) ||
            (allowArrayLike && o && typeof o.length === 'number')
         ) {
            if (it) o = it;
            var i = 0;
   ...
   var Text = {
      ...
      decorations: function decorations(node, _decorations) {
            ...
            for (_iterator.s(); !(_step = _iterator.n()).done; ) {
               ...
               var merge =
                  mergeDecoration !== null && mergeDecoration !== void 0
                     ? mergeDecoration
                     : Object.assign;
               var _iterator3 = _createForOfIteratorHelper$j(leaves),
                  _step3;
               try {
         ...
         if (leaves.length > 1) {
            var currentOffset = 0;
            var _iterator2 = _createForOfIteratorHelper$j(leaves.entries()),
               _step2;
            try {
   ...
   var insertChildren = function insertChildren(xs, index) {
      ...
      return [].concat(
         _toConsumableArray(xs.slice(0, index)),
         newValues,
         _toConsumableArray(xs.slice(index))
      );
   };
   var replaceChildren = function replaceChildren(xs, index, removeCount) {
      ...
      return [].concat(
         _toConsumableArray(xs.slice(0, index)),
         newValues,
         _toConsumableArray(xs.slice(index + removeCount))
      );
   };
    ...
    */
   var modifyDescendant = function modifyDescendant(root, path, f) {
      if (path.length === 0) {
    ...
    */
   var modifyChildren = function modifyChildren(root, path, f) {
      if (path.length === 0) {
         root.children = f(root.children);
      } else {
         modifyDescendant(root, path, function (node) {
            if (Node.isText(node)) {
               throw new Error(
    ...
    */
   var modifyLeaf = function modifyLeaf(root, path, f) {
      return modifyDescendant(root, path, function (node) {
         if (!Node.isText(node)) {
            throw new Error(
               'Cannot get the leaf node at path ['
                  .concat(path, '] because it refers to a non-leaf node: ')
   ...
   function _createForOfIteratorHelper$i(o, allowArrayLike) {
      var it = (typeof Symbol !== 'undefined' && o[Symbol.iterator]) || o['@@iterator'];
      if (!it) {
         if (
            Array.isArray(o) ||
            (it = _unsupportedIterableToArray$i(o)) ||
            (allowArrayLike && o && typeof o.length === 'number')
         ) {
            if (it) o = it;
            var i = 0;
      ...
      transform: function transform(editor, op) {
         ...
         switch (op.type) {
            case 'insert_node': {
               var path = op.path,
                  node = op.node;
               modifyChildren(editor, Path.parent(path), function (children) {
                  var index = path[path.length - 1];
            ...
            case 'insert_text': {
               ...
               modifyLeaf(editor, _path, function (node) {
            ...
            case 'merge_node': {
               ...
               modifyChildren(editor, Path.parent(_path2), function (children) {
            ...
            case 'move_node': {
               ...
               modifyChildren(editor, Path.parent(_path3), function (children) {
                  return removeChildren(children, _index, 1);
               });
               ...
               modifyChildren(editor, Path.parent(truePath), function (children) {
                  return insertChildren(children, newIndex, _node);
               });
               transformSelection = true;
               break;
            }
            case 'remove_node': {
               ...
               modifyChildren(editor, Path.parent(_path4), function (children) {
                  return removeChildren(children, _index2, 1);
               });
               // Transform all the points in the value, but if the point was in the
               // node that was removed we need to update the range or remove it.
               if (editor.selection) {
                  var selection = _objectSpread$a({}, editor.selection);
                  var _iterator = _createForOfIteratorHelper$i(Range.points(selection)),
                     _step;
                  try {
                     for (_iterator.s(); !(_step = _iterator.n()).done; ) {
                        ...
                        if (selection != null && result != null) {
                           ...
                           var prev = void 0;
                           var next = void 0;
                           var _iterator2 = _createForOfIteratorHelper$i(Node.texts(editor)),
                              _step2;
                           try {
                              for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
                                 var _step2$value = _slicedToArray(_step2.value, 2),
            ...
            case 'remove_text': {
               ...
               modifyLeaf(editor, _path5, function (node) {
            ...
            case 'set_node': {
               ...
               modifyDescendant(editor, _path6, function (node) {
            ...
            case 'split_node': {
               ...
               modifyChildren(editor, Path.parent(_path7), function (children) {
                  ...
                  if (Node.isText(node)) {
                     ...
                     nextNode = _objectSpread$a(
                        _objectSpread$a({}, _properties),
                        {},
                        {
                           text: after
                        }
         ...
         if (transformSelection && editor.selection) {
            ...
            var _iterator3 = _createForOfIteratorHelper$i(Range.points(_selection2)),
               _step3;
            try {
               for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
                  var _step3$value = _slicedToArray(_step3.value, 2),
                     _point = _step3$value[0],
                     _key4 = _step3$value[1];
   ...
   var Transforms = _objectSpread$9(
      _objectSpread$9(
         _objectSpread$9(_objectSpread$9({}, GeneralTransforms), NodeTransforms),
         SelectionTransforms
      ),
      TextTransforms
   );
   ...
   function _createForOfIteratorHelper$h(o, allowArrayLike) {
      var it = (typeof Symbol !== 'undefined' && o[Symbol.iterator]) || o['@@iterator'];
      if (!it) {
         if (
            Array.isArray(o) ||
            (it = _unsupportedIterableToArray$h(o)) ||
            (allowArrayLike && o && typeof o.length === 'number')
         ) {
            if (it) o = it;
            var i = 0;
   ...
   function updateDirtyPaths(editor, newDirtyPaths, transform) {
      ...
      if (transform) {
         ...
         var _iterator = _createForOfIteratorHelper$h(oldDirtyPaths),
            _step;
         try {
            for (_iterator.s(); !(_step = _iterator.n()).done; ) {
      ...
      var _iterator2 = _createForOfIteratorHelper$h(newDirtyPaths),
         _step2;
      try {
         for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
   ...
   function _createForOfIteratorHelper$g(o, allowArrayLike) {
      var it = (typeof Symbol !== 'undefined' && o[Symbol.iterator]) || o['@@iterator'];
      if (!it) {
         if (
            Array.isArray(o) ||
            (it = _unsupportedIterableToArray$g(o)) ||
            (allowArrayLike && o && typeof o.length === 'number')
         ) {
            if (it) o = it;
            var i = 0;
   ...
   var apply = function apply(editor, op) {
      var _iterator = _createForOfIteratorHelper$g(Editor.pathRefs(editor)),
         _step;
      try {
         for (_iterator.s(); !(_step = _iterator.n()).done; ) {
            var ref = _step.value;
      ...
      var _iterator2 = _createForOfIteratorHelper$g(Editor.pointRefs(editor)),
         _step2;
      try {
         for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
      ...
      var _iterator3 = _createForOfIteratorHelper$g(Editor.rangeRefs(editor)),
         _step3;
      try {
         for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
   ...
   function _createForOfIteratorHelper$f(o, allowArrayLike) {
      ...
      if (!it) {
         if (
            Array.isArray(o) ||
            (it = _unsupportedIterableToArray$f(o)) ||
            (allowArrayLike && o && typeof o.length === 'number')
         ) {
            if (it) o = it;
            var i = 0;
   ...
   var getDirtyPaths = function getDirtyPaths(editor, op) {
      switch (op.type) {
         ...
         case 'insert_node': {
            ...
            var descendants = Node.isText(node)
               ? []
               : Array.from(Node.nodes(node), function (_ref) {
                    var _ref2 = _slicedToArray(_ref, 2),
                       p = _ref2[1];
         ...
         case 'move_node': {
            ...
            var oldAncestors = [];
            var newAncestors = [];
            var _iterator = _createForOfIteratorHelper$f(Path.ancestors(_path3)),
               _step;
            try {
               for (_iterator.s(); !(_step = _iterator.n()).done; ) {
            ...
            var _iterator2 = _createForOfIteratorHelper$f(Path.ancestors(newPath)),
               _step2;
            try {
               for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
   ...
   var normalizeNode = function normalizeNode(editor, entry, options) {
      var _entry = _slicedToArray(entry, 2),
         node = _entry[0],
         path = _entry[1]; // node is not yet normalized, treat as hostile
         ...
         for (var n = 0; n < element.children.length; n++) {
            ...
            if (Node.isText(_child)) {
               ...
               if (
                  prev != null &&
                  Node.isText(prev) &&
                  !Node.isNoLinkAutoWrapText(_child) &&
                  !Node.isNoLinkAutoWrapText(prev)
               ) {
                ...
                * https://online.saby.ru/opendoc.html?guid=230cdb08-b334-43f0-b1fd-22fcbf6635ef&client=3
                */
               if (editor.isInline(_child) || Node.isNoLinkAutoWrapText(_child)) {
                  // Ensure that inline nodes and unlinked text are surrounded by text nodes.
   ...
   var above = function above(editor) {
      ...
      var _Editor$levels = Editor.levels(editor, {
            at: path,
            voids: voids,
            match: match,
            reverse: reverse
         }),
         _Editor$levels2 = _slicedToArray(_Editor$levels, 1),
         firstMatch = _Editor$levels2[0];
   ...
   function _createForOfIteratorHelper$e(o, allowArrayLike) {
      ...
      if (!it) {
         if (
            Array.isArray(o) ||
            (it = _unsupportedIterableToArray$e(o)) ||
            (allowArrayLike && o && typeof o.length === 'number')
         ) {
            if (it) o = it;
            var i = 0;
   ...
   function _createForOfIteratorHelper$d(o, allowArrayLike) {
      ...
      if (!it) {
         if (
            Array.isArray(o) ||
            (it = _unsupportedIterableToArray$d(o)) ||
            (allowArrayLike && o && typeof o.length === 'number')
         ) {
            if (it) o = it;
            var i = 0;
         ...
         _objectSpread$5(
            ...
            {},
            {
               match: function match(n) {
                  return Node.isElement(n) && Editor.isElementReadOnly(editor, n);
               }
            }
         )
      );
   ...
   var getVoid = function getVoid(editor) {
      ...
      return Editor.above(
         ...
         _objectSpread$4(
            ...
            {
               match: function match(n) {
                  return Node.isElement(n) && Editor.isVoid(editor, n);
               }
            }
         )
      );
   ...
   var hasInlines = function hasInlines(editor, element) {
      return element.children.some(function (n) {
         return Node.isText(n) || Editor.isInline(editor, n);
      });
   };
   ...
   function _createForOfIteratorHelper$c(o, allowArrayLike) {
      ...
      if (!it) {
         if (
            Array.isArray(o) ||
            (it = _unsupportedIterableToArray$c(o)) ||
            (allowArrayLike && o && typeof o.length === 'number')
         ) {
            if (it) o = it;
            var i = 0;
               ...
               while (1)
                  switch ((_context.prev = _context.next)) {
                     ...
                     case 27:
                        ...
                        return _context.delegateYield(levels, 't1', 29);
                     case 29:
                     case 'end':
                        return _context.stop();
                  }
   ...
   var marks = function marks(editor) {
      ...
      if (anchor.offset === 0) {
         ...
         var markedVoid = Editor.above(editor, {
            match: function match(n) {
               return Node.isElement(n) && Editor.isVoid(editor, n) && editor.markableVoid(n);
            }
         });
         if (!markedVoid) {
   ...
   function _createForOfIteratorHelper$b(o, allowArrayLike) {
      ...
      if (!it) {
         if (
            Array.isArray(o) ||
            (it = _unsupportedIterableToArray$b(o)) ||
            (allowArrayLike && o && typeof o.length === 'number')
         ) {
            if (it) o = it;
            var i = 0;
               ...
               while (1)
                  switch ((_context.prev = _context.next)) {
                     ...
                     case 51:
                        ...
                        return _context.delegateYield(matches, 't1', 53);
                     case 53:
                     case 'end':
                        return _context.stop();
                  }
   ...
   function _createForOfIteratorHelper$a(o, allowArrayLike) {
      ...
      if (!it) {
         if (
            Array.isArray(o) ||
            (it = _unsupportedIterableToArray$a(o)) ||
            (allowArrayLike && o && typeof o.length === 'number')
         ) {
            if (it) o = it;
            var i = 0;
   ...
   var normalize = function normalize(editor) {
      ...
      if (force) {
         ...
         var allPathKeys = new Set(
            allPaths.map(function (p) {
               return p.join(',');
            })
         );
   ...
   function _createForOfIteratorHelper$9(o, allowArrayLike) {
      ...
      if (!it) {
         if (
            Array.isArray(o) ||
            (it = _unsupportedIterableToArray$9(o)) ||
            (allowArrayLike && o && typeof o.length === 'number')
         ) {
            if (it) o = it;
            var i = 0;
               ...
               while (1)
                  switch ((_context3.prev = _context3.next)) {
                     ...
                     case 4:
                        ...
                        (_Range$edges = Range.edges(range)),
                           (_Range$edges2 = _slicedToArray(_Range$edges, 2)),
                           (start = _Range$edges2[0]),
                           (end = _Range$edges2[1]);
                        ...
                        leafTextRemaining = 0;
                        leafTextOffset = 0;
                        skippedPaths = []; // Iterate through all nodes in range, grabbing entire textual content
                        // of block nodes in blockText, and text nodes in leafText.
                        // Exploits the fact that nodes are sequenced in such a way that we first
                        // encounter the block node, then all of its text nodes, so when iterating
                        // through the blockText and leafText we just need to remember a window of
                        // one block node and leaf node, respectively.
                        _iterator = _createForOfIteratorHelper$9(
                           Editor.nodes(editor, {
                              at: at,
                              reverse: reverse,
                              voids: voids
                        ...
                        _loop = /*#__PURE__*/ regenerator.mark(function _loop() {
                           ...
                           return regenerator.wrap(function _loop$(_context2) {
                              while (1)
                                 switch ((_context2.prev = _context2.next)) {
                                    case 0:
                                       maybeYield = function _maybeYield(point) {
                                          return regenerator.wrap(function maybeYield$(_context) {
                                             while (1)
                                                switch ((_context.prev = _context.next)) {
                                                   case 0:
                                       ...
                                       _marked = /*#__PURE__*/ regenerator.mark(maybeYield);
                                       (_step$value = _slicedToArray(_step.value, 2)),
                                          (node = _step$value[0]),
                                          (path = _step$value[1]);
                                       ...
                                       hasSkippedAncestor = skippedPaths.some(function (p) {
                                          return Path.isAncestor(p, path);
                                       });
                                       if (!Node.isElement(node)) {
                                          _context2.next = 23;
                                          break;
                                       ...
                                       return _context2.delegateYield(
                                          maybeYield(Editor.end(editor, Path.previous(path))),
                                          't0',
                                          10
                                       );
                                    case 10:
                                    ...
                                    case 13:
                                       ...
                                       return _context2.delegateYield(
                                          maybeYield(Editor.start(editor, nextPath)),
                                          't1',
                                          16
                                       );
                                    case 16:
                                    ...
                                    case 17:
                                       ...
                                       return _context2.delegateYield(
                                          maybeYield(Editor.start(editor, path)),
                                          't2',
                                          19
                                       );
                                    case 19:
                                    ...
                                    case 22:
                                       ...
                                       if (Editor.hasInlines(editor, node)) {
                                          ...
                                          e = Path.isAncestor(path, end.path)
                                             ? end
   ...
   function _createForOfIteratorHelper$8(o, allowArrayLike) {
      ...
      if (!it) {
         if (
            Array.isArray(o) ||
            (it = _unsupportedIterableToArray$8(o)) ||
            (allowArrayLike && o && typeof o.length === 'number')
         ) {
            if (it) o = it;
            var i = 0;
   ...
   var string = function string(editor, at) {
      ...
      var text = '';
      var _iterator = _createForOfIteratorHelper$8(
            Editor.nodes(editor, {
               at: range,
               match: Node.isText,
               voids: voids
   ...
   function _createForOfIteratorHelper$7(o, allowArrayLike) {
      ...
      if (!it) {
         if (
            Array.isArray(o) ||
            (it = _unsupportedIterableToArray$7(o)) ||
            (allowArrayLike && o && typeof o.length === 'number')
         ) {
            if (it) o = it;
            var i = 0;
   ...
   var shouldMergeNodesRemovePrevNode = function shouldMergeNodesRemovePrevNode(
      editor,
      _ref,
      _ref2
   ) {
      ...
      return (
         ...
         (Node.isText(prevNode) && prevNode.text === '' && prevPath[prevPath.length - 1] !== 0)
      );
   };
   ...
   function _createForOfIteratorHelper$6(o, allowArrayLike) {
      ...
      if (!it) {
         if (
            Array.isArray(o) ||
            (it = _unsupportedIterableToArray$6(o)) ||
            (allowArrayLike && o && typeof o.length === 'number')
         ) {
            if (it) o = it;
            var i = 0;
   ...
   var deleteText = function deleteText(editor) {
      ...
      Editor.withoutNormalizing(editor, function () {
         ...
         var startNonEditable = voids
            ? null
            : (_Editor$void = Editor['void'](editor, {
                 at: start,
                 mode: 'highest'
              })) !== null && _Editor$void !== void 0
            ? _Editor$void
            : Editor.elementReadOnly(editor, {
                 at: start,
                 mode: 'highest'
              });
         var endNonEditable = voids
            ? null
            : (_Editor$void2 = Editor['void'](editor, {
                 at: end,
                 mode: 'highest'
              })) !== null && _Editor$void2 !== void 0
            ? _Editor$void2
            : Editor.elementReadOnly(editor, {
                 at: end,
                 mode: 'highest'
         ...
         var matches = [];
         var lastPath;
         var _iterator = _createForOfIteratorHelper$6(
               Editor.nodes(editor, {
                  at: at,
                  voids: voids
               })
         ...
         try {
            for (_iterator.s(); !(_step = _iterator.n()).done; ) {
               ...
               if (
                  (!voids &&
                     Node.isElement(_node2) &&
                     (Editor.isVoid(editor, _node2) || Editor.isElementReadOnly(editor, _node2))) ||
                  (!Path.isCommon(_path2, start.path) && !Path.isCommon(_path2, end.path))
               ) {
                  matches.push(entry);
                  lastPath = _path2;
               }
   ...
   function _createForOfIteratorHelper$5(o, allowArrayLike) {
      ...
      if (!it) {
         if (
            Array.isArray(o) ||
            (it = _unsupportedIterableToArray$5(o)) ||
            (allowArrayLike && o && typeof o.length === 'number')
         ) {
            if (it) o = it;
            var i = 0;
   ...
   var insertFragment = function insertFragment(editor, fragment) {
      ...
      Editor.withoutNormalizing(editor, function () {
         ...
         var inlineElementMatch = Editor.above(editor, {
            at: at,
            match: function match(n) {
               return Node.isElement(n) && Editor.isInline(editor, n);
            },
            mode: 'highest',
            voids: voids
         });
         ...
         // nodes individually.
         var shouldInsert = function shouldInsert(_ref) {
            var _ref2 = _slicedToArray(_ref, 2),
               n = _ref2[0],
               p = _ref2[1];
         ...
         // empty.
         var ends = [];
         var _iterator = _createForOfIteratorHelper$5(
               Node.nodes(
                  {
                     children: fragment
                  },
         ...
         try {
            for (_iterator.s(); !(_step = _iterator.n()).done; ) {
               ...
               if (
                  ...
                  !Path.isAncestor(_path, firstLeafPath)
               ) {
                  starting = false;
               }
   ...
   var setPoint = function setPoint(editor, props) {
      ...
      Transforms.setSelection(
         ...
         _defineProperty(
            ...
            _objectSpread$1(_objectSpread$1({}, point), props)
         )
      );
   };
   ...
   var setSelection = function setSelection(editor, props) {
      ...
      for (var k in props) {
         if (
            ...
            (k === 'focus' && props.focus != null && !Point.equals(props.focus, selection.focus)) ||
   ...
   var hasSingleChildNest = function hasSingleChildNest(editor, node) {
      return (
         ...
         (Node.isText(node) ||
            Editor.isVoid(editor, node) ||
            (node.children.length === 1 && hasSingleChildNest(editor, node.children[0])))
      );
   };
         ...
         if (Node.isText(node) && Node.isText(prevNode)) {
            ...
            throw new Error(
               'Cannot merge the node at path ['
                  .concat(path, '] with the previous sibling because it is not the same kind: ')
                  .concat(Scrubber.stringify(node), ' ')
   ...
   var splitNodes = function splitNodes(editor) {
      ...
      Editor.withoutNormalizing(editor, function () {
         ...
         try {
            ...
            var _iterator = _createForOfIteratorHelper$2(
                  Editor.levels(editor, {
                     at: lowestPath,
                     reverse: true,
                     voids: voids
         ...
         try {
            var _loop = function _loop() {
               ...
               Transforms.liftNodes(editor, {
                  at: range,
                  match: function match(n) {
                     return !Node.isText(node) && node.children.includes(n);
                  },
                  voids: voids
               });
            };
      ...
      Editor.withoutNormalizing(editor, function () {
         ...
         if (match == null) {
            if (Location.isPath(at)) {
               ...
               match = function match(n) {
                  return (Node.isElement(n) && Editor.isInline(editor, n)) || Node.isText(n);
               };
            } else {
               match = function match(n) {
                  return Node.isElement(n) && Editor.isBlock(editor, n);
         ...
         if (split && Location.isRange(at)) {
            ...
            var isAtBlockEdge = function isAtBlockEdge(point) {
         ...
         var _loop = function _loop() {
               ...
               if (matches.length > 0) {
                  ...
                  Transforms.moveNodes(editor, {
                     at: range,
                     match: function match(n) {
                        return !Node.isText(commonNode) && commonNode.children.includes(n);
                     },
