...
(b.graphic=b.graphic.destroy())},this)},drawGraph:c.noop,animate:function(a){a?this.markerGroup.attr({opacity:.01}):(this.markerGroup.animate({opacity:1},c.animObject(this.options.animation)),this.animate=null)}})})(c)});