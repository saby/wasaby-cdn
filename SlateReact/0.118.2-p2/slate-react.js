...
(function (global, factory) {
   if (typeof module === 'object' && typeof module.exports === 'object') {
      ...
      factory(module.exports, req('react'), req('react-dom'), req('/cdn/Slate/0.118.1-p1/slate.min.js'), req('Env/Env'));
   } else if (typeof define === 'function' && define.amd) {
      define(['exports', 'react', 'react-dom', '/cdn/Slate/0.118.1-p1/slate.min.js', 'Env/Env'], factory);
   }
})(typeof globalThis !== 'undefined' ? globalThis : this, function (exports, React, ReactDOM, slate, env) {
   ('use strict');
