...
def workspace = "/home/sbis/workspace/wasaby_cdn_${version}/${BRANCH_NAME}"
    ws (workspace){
        ...
        checkout([$class: 'GitSCM',
            ...
            branches: [[name: "19.600/feature/build-with-jinnee"]],
        ...
        start = load "./jenkins_pipeline/platforma/branch/JenkinsfileCDN"
        ...
        timeout(time: 60, unit: 'MINUTES') {
			...
			try {
				...
				helper.time_stages(diff_time, "${BUILD_URL}", version, "wasaby-cdn")
			}
        }
    }
}