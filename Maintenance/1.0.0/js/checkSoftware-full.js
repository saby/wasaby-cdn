(function(window) {
   ...
   (function checkVersion(force, justGetInfo) {
      var urlGETparams = document.location.search.substr(1).split('&').reduce(function (params, param) {
         var name = param.split('=').shift();
         var value = param.split('=').pop();
         params[name] = value;
         return params;
      }, {});
      if (urlGETparams['nocheck'] == 1) { return ;}
