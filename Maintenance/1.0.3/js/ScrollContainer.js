var ScrollConatainerInit = (function () {
   ...
   // var footer = document.querySelector('.ScrollContainer__footer');
   ...
   function toggleBottomShadow(show) {
      ...
      show ? $.removeClass(footer, 'ws-invisible') : $.addClass(footer, 'ws-invisible');
   }
   ...
   function calcThumbHeight(thumb, scrollbarAvailableHeight, viewportRatio) {
      ...
      var style = getComputedStyle(thumb);
