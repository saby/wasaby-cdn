...
function isDomenForIE() {
   ...
   return isAutoTest || (domains.length === 3 && domains[0].split('-').some(function (search) {
      return search == 'ie';
   }));
}
...
(function () {
   ...
   function redirect() {
      ...
      var DIAGNOSTIC_PAGE = '/cdn/Maintenance/1.0.26/html/diagnostic.html';
