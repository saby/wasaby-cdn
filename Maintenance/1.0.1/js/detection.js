...
var OS = /** @class */ (function () {
   ...
   OS.detect = function (userAgent_) {
       ...
       var osName = null;
       for (var name_1 in OS.list) {
           if (!OS.list.hasOwnProperty(name_1)) {
               continue;
           }
           if (OS.list[name_1].reg.test(userAgent)) {
               osName = name_1;
           }
       }
       if (osName) {
...
var Browser = (function () {
   ...
   Browser.detect = function (userAgent_) {
       ...
       for (var name_1 in Browser.list) {
           if (!Browser.list.hasOwnProperty(name_1)) {
               continue;
           }
           if (Browser.list[name_1].reg.test(userAgent)) {
               browserName = name_1;
           }
       }
       if (browserName) {
