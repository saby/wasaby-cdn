...
var expryDate = new Date('2026-01-01');
...
var OS = /** @class */ (function () {
    ...
    OS.detect = function (userAgent_) {
        ...
        return {
            ...
            version: version,
            family: family,
            expryDate: version <= family.nextavailable && version >= family.available ? expryDate : undefined
        };
    };
    /** Семейства ОС */
    OS.family = {
...
var Browser = (function () {
    ...
    Browser.detect = function (userAgent_) {
        ...
        var _a = family.version,
            ...
            nextavailable = _a.nextavailable;
        var version =
        ...
        return {
            ...
            version: version,
            family: family,
            expryDate: version <= nextavailable && version >= available ? expryDate : undefined
        };
    };
    Browser.family = {
        YaBrowser: {
...
(function () {
    ...
    function redirect() {
        ...
        var DIAGNOSTIC_PAGE = '/cdn/Maintenance/1.0.42/html/diagnostic.html';
