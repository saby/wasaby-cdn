...
(function () {
   ...
   if (isTouchScreen()) {
       ...
       */
      var TOUCHSCREEN_COOKIE_KEY = 'is_touchscreen';
      document.cookie = TOUCHSCREEN_COOKIE_KEY + '=true;path=/';
   }
   ...
   function redirect() {
      ...
      var DIAGNOSTIC_PAGE = '/cdn/Maintenance/1.0.10/html/diagnostic.html';
