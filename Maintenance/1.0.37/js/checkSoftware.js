...
(function () {
   ...
   if (!isDomenForIE()) {
      ...
      if (chechYandexForOldWindows(window.navigator.userAgent) && !regCheck()) {
         redirectToIESaby();
         return;
      }
   ...
   function redirect() {
      ...
      var DIAGNOSTIC_PAGE = '/cdn/Maintenance/1.0.37/html/diagnostic.html';
   ...
   function redirectToIESaby() {
      ...
      var newHref = window.location.protocol + '//' + targetLocation
         + returnLink;
