   ...
   function StompCreator() {
      ...
      Frame = (function () {
         ...
         unmarshallSingle = function (data) {
            ...
            // For spec up to v1.2
            // but unknown sequences are not treated as protocol errors, leaving untouched
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
               line = _ref[_i];
               idx = line.indexOf(':');
               headers[trim(line.substring(0, idx))] = convertHeaderValue(
                  trim(line.substring(idx + 1))
               );
            }
            body = '';
            start = divider + 2;
      ...
      Client = (function () {
                  ...
                  (function (_this) {
                     return function () {
                        try {
                           ...
                           _this.debug("WARNING: can't send heartbeat. Reason: " + e.message);
                        }
                     };
                  })(this)
               );
                  ...
                  for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                     ...
                     switch (frame.command) {
                        ...
                        case 'MESSAGE':
                           ...
                           // if (onreceive) {
                           // рассчитываем что фильтрация проходит на сервере
                           client = _this;
                        ...
                        case 'ERROR':
                           _results.push(
                              typeof errorCallback === 'function' ? errorCallback(frame) : void 0
                           );
                           break;
                        default:
                           _results.push(
         ...
         Client.prototype.disconnect = function (disconnectCallback, headers) {
            ...
            // делать close нужно в любом случае
            try {
